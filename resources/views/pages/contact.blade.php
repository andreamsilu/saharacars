...
@php
    ...
    $contactFacebookUrl = trim((string) config('sahara.facebook_url'));
    $contactFacebookLabel = trim((string) config('sahara.facebook_label'));
...
<h1 class="font-headline text-editorial-hero font-extrabold text-primary tracking-tight mb-4 text-balance">{{ __('public.contact.hero_title') }}</h1>
<p class="text-on-surface-variant max-w-2xl text-editorial-body">{{ __('public.contact.hero_subtitle') }}</p>
</header>
<!-- Bento Grid Layout -->
...
<h2 class="font-headline text-editorial-section-title font-extrabold text-primary tracking-tight leading-tight mb-8">{{ __('public.contact.form_heading') }}</h2>
@if (session('status'))
...
<h3 class="font-headline text-editorial-section-title font-extrabold tracking-tight leading-tight mb-6">{{ __('public.contact.immediate_support') }}</h3>
<div class="space-y-6">
...
<div>
<p class="font-label text-editorial-kicker opacity-70">{{ __('public.contact.label_whatsapp') }}</p>
...
<div>
<p class="font-label text-editorial-kicker opacity-70">{{ __('public.contact.label_email') }}</p>
...
<div>
<p class="font-label text-editorial-kicker opacity-70">{{ __('public.contact.label_website') }}</p>
...
<x-icons.instagram class="w-6 h-6 text-white" />
</div>
<div>
<p class="font-label text-editorial-kicker opacity-70">{{ __('public.contact.label_instagram') }}</p>
...
@endif
@if(filled($contactFacebookUrl))
<a class="flex items-center gap-4 group/btn p-3 -m-3 hover:bg-white/10 rounded-xl transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white" href="{{ $contactFacebookUrl }}" target="_blank" rel="noopener noreferrer" aria-label="{{ __('public.contact.facebook_aria', ['label' => filled($contactFacebookLabel) ? $contactFacebookLabel : '']) }}">
<div class="w-12 h-12 bg-white/10 flex items-center justify-center rounded-full" aria-hidden="true">
<x-icons.facebook class="w-6 h-6 text-white" />
</div>
<div>
<p class="font-label text-editorial-kicker opacity-70">{{ __('public.contact.label_facebook') }}</p>
<p class="font-headline font-bold">{{ filled($contactFacebookLabel) ? $contactFacebookLabel : config('sahara.facebook_fallback_caption') }}</p>
</div>
</a>
@endif
</div>
...
<div class="inline-block px-4 py-1.5 bg-secondary-container text-on-secondary-container rounded-full font-label text-editorial-kicker mb-6">{{ __('public.contact.location_badge') }}</div>
