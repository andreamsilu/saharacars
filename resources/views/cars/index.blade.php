...
<x-public-seo
    :title="__('public.meta.inventory_title', ['company' => config('sahara.legal_entity_name')])"
    :description="__('public.meta.inventory_description', ['company' => config('sahara.legal_entity_name')])"
